...
class PayrollDetail extends Model
{
    protected $fillable = [
        ...
        'commissions', 'bonuses', 'non_salary_bonuses', 'disability_days', 'disability_value',
        'vacation_days', 'vacation_value', 'other_income', 'total_earned',
        'health_employee', 'pension_employee', 'solidarity_fund',
        'income_tax_withholding', 'advance_deduction', 'advances_details', 'loan_deduction', 'cooperative_deduction',
