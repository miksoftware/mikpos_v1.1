            ...
            <div class="p-3 bg-gradient-to-r from-orange-50 to-purple-50 border-b border-orange-200">
                <div class="flex items-center justify-between gap-3">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <div class="min-w-0">
                            <p class="text-sm font-semibold text-slate-800 truncate">Convirtiendo cotización <span class="text-[#a855f7]">{{ $fromQuoteNumber }}</span></p>
                            <p class="text-xs text-slate-600 truncate">Items y precios cargados desde la cotización. Procesa el pago para completar la venta.</p>
                        </div>
                    </div>
                    <button wire:click="cancelQuoteConversion" type="button" class="text-xs text-slate-500 hover:text-red-600 font-medium px-2.5 py-1.5 rounded-lg hover:bg-red-50 border border-slate-200 hover:border-red-200 transition flex items-center gap-1.5 flex-shrink-0" title="Cancelar conversión">
                ...
                <div class="relative w-full max-w-xl bg-white rounded-2xl shadow-2xl">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="p-4 bg-slate-50 rounded-xl border border-slate-200">
                            ...
                            <input wire:model="paymentDueDate" type="date" min="{{ date('Y-m-d') }}" class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 text-sm">
                            @error('paymentDueDate') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>
                        @endif
