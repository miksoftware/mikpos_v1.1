<div class="space-y-6" x-data="{}" x-on:print-expense.window="(e) => { window.open('/expense-receipt/' + e.detail.expenseId, '_blank'); }">
    <x-toast />
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-1">
                                <button wire:click="printExpense({{ $item->id }})" class="p-2 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors" title="Imprimir Comprobante">
