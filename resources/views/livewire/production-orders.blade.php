                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-1">
                                ...
                                <button type="button"
                                    data-confirm="Se revertirá el stock del producto fabricado y se restaurarán los insumos consumidos."
                                    data-confirm-title="¿Cancelar orden de producción?"
                                    data-confirm-method="cancelOrder"
                                    data-confirm-params="[{{ $order->id }}]"
                                    class="p-1.5 text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors" title="Cancelar Orden">
                    ...
                    <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button type="button"
                                ...
                                data-confirm-title="¿Cancelar orden de producción?"
                                data-confirm-method="cancelOrder"
                                data-confirm-params="[{{ $selectedOrder->id }}]"
                                class="inline-flex items-center px-3 py-1.5 bg-red-50 hover:bg-red-100 text-red-600 text-sm font-semibold rounded-lg transition-colors">
                                Cancelar Orden
                            </button>
                            @endif
