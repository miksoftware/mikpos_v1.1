        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-slate-200">
                <thead class="bg-slate-50">
                    <tr>
                        <th class="px-6 py-4 text-left text-xs font-semibold text-slate-500 uppercase">Color</th>
                        <th class="px-6 py-4 text-left text-xs font-semibold text-slate-500 uppercase">Nombre</th>
                        <th class="px-6 py-4 text-center text-xs font-semibold text-slate-500 uppercase">Código HEX</th>
                ...
                <tbody class="divide-y divide-slate-200">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center"><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-mono bg-slate-100 text-slate-700">{{ $item->hex_code ?? '-' }}</span></td>
            ...
            <div class="relative w-full max-w-md bg-white rounded-2xl shadow-xl">
                ...
                <div class="px-6 py-4 space-y-4">
                    ...
                    <div><label class="block text-sm font-medium text-slate-700 mb-1">Código HEX</label>
                        ...
                        @error('hex_code')<span class="text-red-500 text-xs">{{ $message }}</span>@enderror
                    </div>
