                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200 {{ $barcode['is_primary'] ? 'ring-2 ring-purple-500 ring-offset-1' : '' }}">
                                    ...
                                    <div class="flex items-center gap-1 ml-2">
                                        ...
                                        @endif
                                        <button type="button" x-on:click="confirmAction('Esta acción no se puede deshacer.', () => $wire.deleteBarcode({{ $barcode['id'] }}), { title: '¿Eliminar este código de barras?' })" class="p-1.5 text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors" title="Eliminar">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                        </button>
                                    </div>
                                </div>
