            ...
            <div class="rounded-2xl border border-violet-200 bg-violet-50 p-5 space-y-4">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <button wire:click="subscribeAppToWaba" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-violet-700 bg-violet-200 rounded-xl hover:bg-violet-300 transition-colors">
                            <svg wire:loading.remove wire:target="subscribeAppToWaba" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"></path>
                            </svg>
                            <svg wire:loading wire:target="subscribeAppToWaba" class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <span wire:loading.remove wire:target="subscribeAppToWaba">Suscribir App</span>
                            <span wire:loading wire:target="subscribeAppToWaba">Suscribiendo...</span>
                        </button>
