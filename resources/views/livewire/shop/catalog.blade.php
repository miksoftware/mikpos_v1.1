<div x-data="{ fullscreenImage: false, imageUrl: '' }">
    ...
    <div class="mb-6 space-y-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <a href="{{ route('shop.catalog.pdf', ['branch_slug' => $branch?->slug ?? session('ecommerce_branch_slug')]) }}" target="_blank"
                class="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-white bg-gradient-to-r from-[#ff7261] to-[#a855f7] hover:from-[#e55a4a] hover:to-[#9333ea] rounded-xl shadow-sm hover:shadow transition-all">
                ...
                <div class="fixed inset-y-0 right-0 z-[91] w-full max-w-sm bg-white shadow-xl flex flex-col">
                    ...
                    @if($this->cartCount > 0)
                        <div class="px-5 py-4 border-t border-slate-200 space-y-3 flex-shrink-0">
                            ...
                            <a href="{{ route('shop.checkout', ['branch_slug' => $branch?->slug ?? session('ecommerce_branch_slug')]) }}" class="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-[#ff7261] to-[#a855f7] rounded-xl hover:from-[#e55a4a] hover:to-[#9333ea] transition-all">
                                Finalizar pedido
