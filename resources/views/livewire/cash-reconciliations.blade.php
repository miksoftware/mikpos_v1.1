                                            ...
                                            <tr class="hover:bg-slate-50 transition-colors">
                                                ...
                                                <td class="px-4 py-3 text-center">
                                                    <div class="flex items-center justify-center gap-2">
                                                        ...
                                                        <button wire:click="deleteMovement({{ $movement->id }})" wire:confirm="¿Está seguro de eliminar este movimiento?" class="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="Eliminar">
