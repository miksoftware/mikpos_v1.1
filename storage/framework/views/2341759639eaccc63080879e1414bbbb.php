<div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($items) === 0): ?>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-12 text-center">
            ...
            <a href="<?php echo e(route('shop.catalog')); ?>" wire:navigate
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl border border-slate-200 p-4 sm:p-5" wire:key="cart-item-<?php echo e($index); ?>">
                        <div class="flex gap-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between gap-2">
                                    <div>
                                        <h3 class="text-sm font-semibold text-slate-900 truncate"><?php echo e($item['name']); ?></h3>
                                        <p class="text-xs text-slate-400 mt-0.5">SKU: <?php echo e($item['sku']); ?></p>
                                    </div>
                                    <button wire:click="removeItem(<?php echo e($index); ?>)" wire:confirm="¿Eliminar este producto del carrito?"
                                ...
                                <p class="text-sm font-medium text-slate-700 mt-2">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['tax_rate'] > 0): ?>
                                        <span class="text-xs text-slate-400">(IVA <?php echo e($item['tax_rate']); ?>% incluido)</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </p>
                                ...
                                <div class="flex items-center justify-between mt-3">
                                    ...
                                    <div class="flex items-center border border-slate-300 rounded-xl overflow-hidden">
                                        <button wire:click="updateQuantity(<?php echo e($index); ?>, <?php echo e(max(1, $item['quantity'] - 1)); ?>)"
                                        ...
                                        <input type="number" value="<?php echo e($item['quantity']); ?>" min="1" max="<?php echo e((int) $item['max_stock']); ?>"
                                        ...
                                        <button wire:click="updateQuantity(<?php echo e($index); ?>, <?php echo e($item['quantity'] + 1); ?>)"
                                            class="px-2.5 py-1.5 text-slate-600 hover:bg-slate-100 transition-colors disabled:opacity-50"
                                            <?php echo e($item['quantity'] >= (int) $item['max_stock'] ? 'disabled' : ''); ?>>
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <p class="text-sm font-bold text-slate-900">
                                        $<?php echo e(number_format($item['unit_price'] * $item['quantity'], 0, ',', '.')); ?>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-5 sticky top-24">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex justify-between text-slate-600">
                            <span>Productos (<?php echo e($this->itemCount); ?>)</span>
                            <span>$<?php echo e(number_format($this->subtotal, 0, ',', '.')); ?></span>
                        </div>
                        <div class="flex justify-between text-slate-600">
                            <span>IVA incluido</span>
                            <span>$<?php echo e(number_format($this->taxTotal, 0, ',', '.')); ?></span>
                        </div>
                        <hr class="border-slate-200">
                        <div class="flex justify-between text-base font-bold text-slate-900">
                            <span>Total</span>
                            <span>$<?php echo e(number_format($this->total, 0, ',', '.')); ?></span>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\mikpos_v1.1\resources\views/livewire/shop/cart.blade.php ENDPATH**/ ?>